...
export const RecentPosts = () => {
    ...
    return (
        <div className=" bg-pink-primary border-4 border-black dark:border-white px-6 py-10 xl:py-16 xl:px-14">
            <h2 className="heading-1 dark:text-black">Recent Posts</h2>
